...
const HomeCardLink = ({ link, title, children, bg }: HomeCardLinkProps): React.ReactElement => {
    ...
    return (
        ...
        >
            <div className="z-10">
                <div className="flex flex-wrap text-2xl font-semibold mt-6 mb-2" style={{ paddingTop: '60%' }}>
                    {title}
            ...
            <div
                className="absolute bg-yellow-500 bg-opacity-75 left-1/2 bottom-0 transform rotate-8 -translate-x-1/2 translate-y-16 lg:h-280px h-240px -z-10"
